...
현재는 실제 Slack Socket Mode 연결에서 첫 `app_mention` 수신·검증과 고정 확인 응답까지 검증하고, 기존 다음 공고 분석 동작을 연결하는 단계입니다.
...
3. Slack 명령으로 다음 공고 1건 분석과 요약 응답 실제 확인
4. 하루 1회 예약 실행

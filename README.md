...
임시 프로필로 비교할 때도 이력서에서 읽은 경력 맥락과 공고 기술에 연결되는 문서 근거를 Slack 응답에 표시합니다. 문서에 근거가 있다는 사실과 요구 수준을 충족한다는 판정은 구분합니다. 기술 수준이 미확인인 경우 경험 전체를 다시 요구하지 않고 해당 근거의 실제 사용 수준을 확인하도록 안내합니다. 경력 맥락 표시는 아직 직무별 경력 연수나 업무 적합도의 자동 판정이 아닙니다.

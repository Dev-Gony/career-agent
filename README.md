...
2. 활성 프로필에서 검색 계획을 다시 생성하고 공고 발견·분석 전체 흐름을 재실행
3. 실제 Slack 첨부부터 개인화 공고 추천까지 전체 흐름을 검증
4. 추천에 대한 사용자 피드백과 공식 채용 소스를 단계적으로 확장
